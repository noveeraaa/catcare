				...
				<div class="section bg-transparent min-vh-100 p-0 m-0">
					<div class="vertical-middle">
						<div class="container-fluid py-5 mx-auto">
							...
							<div class="card mx-auto rounded-0 border-0" style="max-width: 400px; background-color: rgba(255,255,255,0.93); margin-top: 100px;">
								<div class="card-body" style="padding: 40px;">
									<form id="login-form" name="login-form" class="mb-0" action="<?= base_url('home/masuk'); ?>" method="post">
										...
										<?php if (session()->getFlashKeys()): ?>
												...
												<?php echo session()->getFlashdata('belumloginpesan'); ?>
										<?php endif; ?>
										...
										<div class="row">
											...
											<div class="col-12 form-group">
												...
												<a href="<?= base_url('home/register'); ?>" class="float-right">Belum Punya Akun?</a>
											</div>
										</div>
									</form>
								</div>
